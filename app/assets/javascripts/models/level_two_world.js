...
LevelTwo.prototype.setCanvas = function(game, x, y, width, height) {
  game.world.setBounds(x, y, width, height);
};

LevelTwo.prototype.setCamera = function(game, player) {
  game.camera.follow(player, 2);
};

LevelTwo.prototype.setFullscreen = function(game) {
