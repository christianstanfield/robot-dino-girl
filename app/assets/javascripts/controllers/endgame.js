...
EndGame.prototype.setConditions = function(score){
  ...
  if (player.position.y > 600 || player.alive === false) {
    ...
    message_layer = this.game.add.sprite(0, 0, 'gameover');
    ...
    message_layer_text = this.game.add.text(this.game.width/2-100, this.game.height/2-250, 'Your score: '+score+'\n'+$('#high-score').text(), { fontSize: '100px', fill: '#FFF' })
